...
var require_object_assign = __commonJS({ "../../node_modules/object-assign/index.js"(exports, module) {
  ...
  function shouldUseNative() {
    try {
      ...
      if (test1[5] = "de", Object.getOwnPropertyNames(test1)[0] === "5") return false;
  ...
  module.exports = shouldUseNative() ? Object.assign : function(target, source) {
    for (var from, to = toObject(target), symbols, s = 1; s < arguments.length; s++) {
      ...
      for (var key in from) hasOwnProperty2.call(from, key) && (to[key] = from[key]);
...
var require_checkPropTypes = __commonJS({ "../../node_modules/prop-types/checkPropTypes.js"(exports, module) {
  ...
  function checkPropTypes(typeSpecs, values, location, componentName, getStack) {
    for (var typeSpecName in typeSpecs) if (has2(typeSpecs, typeSpecName)) {
      var error;
      try {
  ...
  module.exports = function(isValidElement4, throwOnDirectAccess) {
    ...
    function createObjectOfTypeChecker(typeChecker) {
      function validate(props, propName, componentName, location, propFullName) {
        ...
        for (var key in propValue) if (has2(propValue, key)) {
    ...
    function createUnionTypeChecker(arrayOfTypeCheckers) {
      ...
      for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
        ...
        if (typeof checker != "function") return printWarning("Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + getPostfixForTypeWarning(checker) + " at index " + i + "."), emptyFunctionThatReturnsNull;
      }
      function validate(props, propName, componentName, location, propFullName) {
    ...
    function createStrictShapeTypeChecker(shapeTypes) {
      function validate(props, propName, componentName, location, propFullName) {
        ...
        for (var key in allKeys) {
          var checker = shapeTypes[key];
          if (has2(shapeTypes, key) && typeof checker != "function") return invalidValidatorError(componentName, location, propFullName, key, getPreciseType(checker));
    ...
    function isNode(propValue) {
      switch (typeof propValue) {
        ...
        case "object":
          ...
          if (propValue === null || isValidElement4(propValue)) return true;
          var iteratorFn = getIteratorFn(propValue);
          if (iteratorFn) {
            var iterator = iteratorFn.call(propValue), step;
            if (iteratorFn !== propValue.entries) {
              for (; !(step = iterator.next()).done; ) if (!isNode(step.value)) return false;
            } else for (; !(step = iterator.next()).done; ) {
              var entry = step.value;
              if (entry && !isNode(entry[1])) return false;
            }
          } else return false;
          return true;
        default:
...
var renderJsx = (code, options) => {
  ...
  for (let i = 0; i < (options == null ? void 0 : options.skip); i += 1) {
    ...
    if (import_react.default.Children.count(renderedJSX) > 1) return import_client_logger.logger.warn("Trying to skip an array of elements"), null;
