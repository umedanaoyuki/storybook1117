...
// node_modules/@storybook/react/dist/chunk-H7CJXHDS.mjs
...
var act2 = withGlobalActEnvironment(reactAct);
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  var _a, _b;
  let { renderElement, unmountElement } = await import("./react-18-CVMBGMPQ.js"), Story = unboundStoryFn, content = getReactActEnvironment() ? import_react.default.createElement(Story, { ...storyContext }) : import_react.default.createElement(ErrorBoundary, { showMain, showException }, import_react.default.createElement(Story, { ...storyContext })), element = Wrapper ? import_react.default.createElement(Wrapper, null, content) : content;
...
var decorators = [(Story, context) => {
  var _a, _b;
  if (!((_b = (_a = context.parameters) == null ? void 0 : _a.react) == null ? void 0 : _b.rsc)) return React4.createElement(Story, null);
  let major = import_semver.default.major(React4.version), minor = import_semver.default.minor(React4.version);
  if (major < 18 || major === 18 && minor < 3) throw new Error("React Server Components require React >= 18.3");
  return React4.createElement(React4.Suspense, null, React4.createElement(Story, null));
}];
...
react-dom/cjs/react-dom-test-utils.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YD4427JO.js.map
